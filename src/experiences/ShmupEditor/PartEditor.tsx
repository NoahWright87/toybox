...
/**
 * One reusable Part: a name, a position offset from the Unit's own origin
 * (anchors its Weapons and their aim handle — a turret mounted forward of
 * a battleship's center), and a reusable buffet of Weapons. Weapons are
 * edited inline here (expand-in-place, live two-way bound) rather than
 * getting their own dedicated view/session — a Weapon's field count is
 * comparable to the old inline AttackPayloadForm, which never needed a
 * separate Save/Cancel flow either.
 */
export default function PartEditor({ part, units, excludeUnitId, onSave, onCancel, onDraftChange }: PartEditorProps) {
  ...
  return (
    <div className="shmup-enemy-form">
      ...
      <p className="shmup-hint">Position relative to the Unit's own origin — e.g. a turret mounted forward of a ship's center.</p>
