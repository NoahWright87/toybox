...
export function seedFileSystem(store: FileSystemStore): void {
  ...
  // SAVE.DAT/SCORES.DAT. ENEMY-DRAFT.DAT/TILE-DRAFT.DAT hold whichever
  // enemy/tile-plus-encounters is mid-edit (root CLAUDE.md's mandatory
  ...
  store.createFile(shmupEditorDir.id, "README.TXT", {
    fileType: "text", readonly: true,
    content: "Shmup Editor - Noahsoft (in development)\nOpen the tile/enemy editor at /shmup-editor.\nTILES.DAT and ENEMIES.DAT hold your authored libraries as JSON. Each tile's ENCOUNTERS live nested inside its TILES.DAT entry.\n",
  });
  ...
  store.createFile(shmupEditorDir.id, "ENEMY-DRAFT.DAT", { id: SHMUP_EDITOR_ENEMY_DRAFT_ID, fileType: "dat", content: "" });
